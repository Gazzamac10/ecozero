...
from tools import sidebar_module2  # Import your sidebar module
...
with col2:
    st.markdown("<h1>Gaz.Database - Structure</h1>", unsafe_allow_html=True)
...
db1 = databaseSL.SummaryTable(s.gridXarray,s.gridYarray,s.Building_Use,input.facadeType,float(s.floorToCeiling),input.designTypology)
